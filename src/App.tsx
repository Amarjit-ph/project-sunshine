  ...
  return(
    ...
    <div className="bg-gradient-to-b from-violet-600/10 via-transparent">
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8">
        ...
        <div className="flex justify-center">
          <a className="group inline-flex items-center bg-white/10 hover:bg-white/10 border border-white/10 p-1 ps-4 rounded-full shadow-md focus:outline-none focus:bg-white/10" href="../figma.html">
            <p className="me-2 text-white text-sm">
              For Tujita Ningthoujam,<br/>
              "From the moment our eyes met, my heart knew it had found its home in you."
            </p>
        ...
        <div className="max-w-3xl text-center mx-auto">
          <p className="text-lg text-white/70">"A Love That Endured: Timeless glance of school yard love story, ages apart, and the dream of spending life together till dead do apart” - Amarjit pheiroijam</p>
        </div>
...
<footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  ...
  <div class="text-center">
    <div>
      {/* <a class="flex-none text-xl font-semibold text-black dark:text-white" href="#" aria-label="Brand">Amarjit Pheiroijam</a> */}
    </div>
    {/* <!-- End Col --> */}
    ...
    <div class="mt-3">
      ...
      <p class="text-gray-500 dark:text-neutral-500">©A5TP8M Engineering. 2020. All rights reserved.</p>
    </div>
